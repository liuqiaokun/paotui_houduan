...
class DoHtml extends \app\gcadmin\controller\Admin
{
	public function index()
	{
		$this->view->assign("tpList", \app\gcadmin\service\Cms\CatagoryService::tplList(config("xhadmin.default_themes")));
