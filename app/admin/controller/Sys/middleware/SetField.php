...
class SetField extends \app\admin\controller\Admin
{
	public function handle($request, \Closure $next)
	{
		...
		if ($data["is_field"]) {
			$typeField = \app\admin\controller\Sys\service\FieldSetService::typeField() + \app\admin\controller\Sys\service\ExtendService::$fields;
