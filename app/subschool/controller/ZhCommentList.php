...
class ZhCommentList extends Admin
{
	public function index()
	{
		if (!$this->request->isAjax()) {
			...
			$where["a.info_id"] = $this->request->param("info_id", "", "serach_in");
			...
			$res = \app\subschool\service\ZhCommentListService::indexList(formatWhere($where), $field, $orderby, $limit, $page);
			return json($res);
		}
	}
	public function delete()
	{
		...
		try {
			\app\subschool\model\ZhCommentList::destroy(["id" => explode(",", $idx)], true);
		} catch (\Exception $e) {
